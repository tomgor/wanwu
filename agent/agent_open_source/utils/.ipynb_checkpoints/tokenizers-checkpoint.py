...
class CustomTokenizer:
    ...
    def __new__(cls, tokenizer_dir: str = "/home/jovyan/wyy/mcp-server-demo/utils/tokenizers", model_name: str = "deepseek-v3", device: str = None):
        """确保每个模型实例是单例"""
        if model_name not in cls._instances:
            cls._instances[model_name] = super().__new__(cls)
        return cls._instances[model_name]

    def __init__(self, tokenizer_dir: str = "/home/jovyan/wyy/mcp-server-demo/utils/tokenizers", model_name: str = "deepseek-v3", device: str = None):
        """初始化tokenizer"""
