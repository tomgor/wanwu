...
from url_parser.url_single import app  # 替换为你的Flask应用导入路径


def main():
    parser = argparse.ArgumentParser(description='url Flask应用入口点')
    ...
    # 记录日志
    log_file = f"url_single_logs_{args.port}.log"
